            ...
            @forelse($products as $product)
                ...
                <div class="col-md-3">
                    <div class="card shadow-sm h-100 {{ $lowStock ? 'border-danger' : '' }}">
                        ...
                        @else
                            <img src="https://via.placeholder.com/150x150?text=Sem+Imagem" class="card-img-top"
                                alt="Sem imagem">
                        @endif
                        ...
                        <div class="card-body p-2">
                            ...
                            @php
                                $stockPercentage = min(100, $product->stock * 10); // opcional, ajuste conforme necessidade
                                $stockClass =
                                    $product->stock == 0
                                        ? 'bg-danger'
                                        : ($product->stock < 5
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            editModal.addEventListener('show.bs.modal', function(event) {
                ...
                document.getElementById('editProductDescription').value = button.getAttribute(
                    'data-description');
