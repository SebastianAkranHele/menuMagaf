...
<body>
    <div class="container">
        ...
        <main>
            <!-- Hero Section -->
            <section class="hero"
                style="{{ $hero->background_image ? 'background: url(' . asset('storage/' . $hero->background_image) . ') no-repeat center center; background-size: cover; height: 100vh;' : '' }}">
            </section>
            ...
            <section class="social-links">
                ...
                <div class="links-container">
                   <a href="{{ route('client.menu.public', ['clientSlug' => $client->slug]) }}" class="menu-link">
    ...
    <span>Ver Menu Completo</span>
                    ...
                    <!-- Botão Admin -->
                    <a href="{{ url('/client/login') }}" class="social-link admin-color" target="_blank">
